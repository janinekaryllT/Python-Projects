...
if side == "left":
    ...
    'Type "wait" to wait for a boat. Type "swim" so swim across.\n')
    if swim == "wait":
        choose_door = input("Your arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?")
        if choose_door == "blue":
